...
This Repository has been modified to add more generators and Express with a MongoDB connection, to be used as a template for MEAN Projects with AngularJS.
...
* NodeJS
* nodemon
* Node Packages: `npm i gulp webpack -g`
